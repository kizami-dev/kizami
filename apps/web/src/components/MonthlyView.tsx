...
export function MonthlyView() {
  ...
  const { data, leaveByDate, loading, error, reloadKey, reload } = useMonthlyData(guard.status, monthParam);
        ...
        {data ? (
          <>
            ...
            */}
            ...
            <MonthlyAttendanceTable data={data} leaveByDate={leaveByDate} onCorrect={setCorrectionDate} />
          </>
        ) : null}
      </main>
