...
export const ja = {
  ...
  /**
   * 使い方ツアー(components/Tour.tsx、2026-08-27 追加)。初回ログイン時に自動で始まり、
   * 完了・スキップのどちらでもこの端末では自動では出なくなる(設定ハブの「使い方ツアーを見る」から
   * 何度でも見直せる)。steps のキーは lib/tour.ts の TourStepId と1対1で対応する。
   */
  tour: {
    ariaLabel: "使い方ツアー",
    ...
    finish: "終わる",
    skip: "スキップ",
    restartTitle: "使い方ツアーを見る",
    restartDesc: "打刻から申請までの流れを、実際の画面を追いながら確認します。",
    steps: {
      dashboard: {
        title: "ここが入口です",
        body: "未読の通知・承認待ちの申請・期限が近いものがこの枠に集まります。空なら、今日やることはありません。",
      },
      punch: {
        title: "打刻する",
        body: "出勤・休憩・退勤をこのボタンで記録します。押せるボタンは今の状態によって変わります。",
      },
      monthly: {
        title: "今月の記録を見る",
        body: "区分ごとの合計時間です。日ごとの内訳は下の表に並び、打刻が足りない日には警告が付きます。",
      },
      corrections: {
        title: "打刻を直す",
        body: "押し忘れ・押し間違いはここから申請します。月次の表で日付を選んでも同じ申請ができます。",
      },
      leave: {
        title: "休暇を申請する",
        body: "有給の残りを見ながら日付と種別を選びます。半休・時間単位で取れるかは会社の設定によります。",
      },
      notifPrefs: {
        title: "通知の受け取り方",
        body: "打刻忘れや承認の結果を、メールやブラウザ通知でも受け取れます。種類ごとに選べます。",
      },
      settingsHub: {
        title: "会社の設定",
        body: "勤怠のルール・メンバー・通知の送り先はここから開きます。並ぶ項目は持っている権限によって変わります。",
      },
      members: {
        title: "メンバーを招待する",
        body: "招待リンクを送ると、相手はパスワードを決めるだけで使い始められます。入社日を入れておくと有給の付与日数を計算できます。",
      },
      attendance: {
        title: "勤怠のルール",
        body: "日界・法定休日・フレックスの清算期間を決めます。変更は版として記録され、過去の集計は変わりません。",
      },
      closing: {
        title: "月を締める",
        body: "締めるとその月の集計を確定でき、給与へ渡せます。締めた後に修正が入った月は「修正あり」として残ります。",
      },
    },
  },
