...
export const ko = {
  ...
  /** 사용법 투어(components/Tour.tsx, 2026-08-27 추가). steps 키는 lib/tour.ts 의 TourStepId 와 1:1로 대응한다. */
  tour: {
    ariaLabel: "사용법 투어",
    ...
    finish: "마치기",
    skip: "건너뛰기",
    restartTitle: "사용법 투어 보기",
    restartDesc: "출퇴근 기록부터 신청까지의 흐름을 실제 화면을 따라가며 확인합니다.",
    steps: {
      dashboard: {
        title: "여기가 시작점입니다",
        body: "읽지 않은 알림, 승인 대기 중인 신청, 기한이 가까운 항목이 이 칸에 모입니다. 비어 있으면 오늘 할 일은 없습니다.",
      },
      punch: {
        title: "출퇴근을 기록합니다",
        body: "출근·휴게·퇴근을 이 버튼으로 기록합니다. 누를 수 있는 버튼은 현재 상태에 따라 달라집니다.",
      },
      monthly: {
        title: "이번 달 기록 보기",
        body: "구분별 합계 시간입니다. 일별 내역은 아래 표에 나열되고, 기록이 부족한 날에는 경고가 붙습니다.",
      },
      corrections: {
        title: "기록 바로잡기",
        body: "누락이나 잘못된 기록은 여기서 신청합니다. 월별 표에서 날짜를 골라도 같은 신청을 할 수 있습니다.",
      },
      leave: {
        title: "휴가 신청하기",
        body: "남은 연차를 보면서 날짜와 종류를 고릅니다. 반차·시간 단위 사용 가능 여부는 회사 설정에 따릅니다.",
      },
      notifPrefs: {
        title: "알림 받는 방법",
        body: "기록 누락이나 승인 결과를 메일과 브라우저 알림으로도 받을 수 있습니다. 종류별로 선택합니다.",
      },
      settingsHub: {
        title: "회사 설정",
        body: "근태 규칙·멤버·알림 발송처를 여기서 엽니다. 표시되는 항목은 가진 권한에 따라 달라집니다.",
      },
      members: {
        title: "멤버 초대하기",
        body: "초대 링크를 보내면 상대는 비밀번호만 정하면 시작할 수 있습니다. 입사일을 넣어 두면 연차 부여일수를 계산할 수 있습니다.",
      },
      attendance: {
        title: "근태 규칙",
        body: "일 경계·법정휴일·플렉스 정산기간을 정합니다. 변경은 버전으로 기록되어 과거 집계는 바뀌지 않습니다.",
      },
      closing: {
        title: "월 마감하기",
        body: "마감하면 그 달의 집계를 확정해 급여로 넘길 수 있습니다. 마감 후 수정이 들어온 달은 '수정 있음'으로 남습니다.",
      },
    },
  },
