...
import { getNotificationSettings, insertAuditLog, upsertNotificationSettings, type Database, type TenantNotificationSettings } from "@kizami/db";
import { dispatch, type NotificationMessage } from "@kizami/notify";
...
import { NOTIFICATION_SETTINGS_PERMISSION } from "./permissions.js";
...
export function registerNotificationsRoutes(app: Hono<AppEnv>, db: Database, deps: SettingsRoutesDeps) {
