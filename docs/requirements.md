...
| 以降 | ロードマップ | 3ヶ月清算、freee/MF連携、Web Push、多段承認、権限denyルール、オンボーディングツアー<br>実装済み(2026-08-24): **コアタイム**(労基法32条の3。警告のみ・集計に影響しない — [design/work-systems.md](./design/work-systems.md)「コアタイム」) |
